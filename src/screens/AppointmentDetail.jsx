          ...
          >
            ...
            >
              ...
              >
                ...
                <Text style={{ fontWeight: "bold", flex: 1 }}>Không BHYT</Text>
              </View>
              <View
                style={{
                  gap: 10,
            ...
            >
              <Text style={{ textAlign: "justify" }}>
                ...
                đón. Quý bệnh nhân cần hỗ trợ vui lòng liên hệ tổng đài CSKH
                1900 459
              </Text>
              <TouchableOpacity
                style={{
              ...
              >
                <FontAwesome6 name="phone-volume" size={24} color="#0165FC" />
                <View>
            ...
            >
              <Text style={{ color: "#0165FC" }}>Bản quyền thuộc LHT MED</Text>
            ...
            <>
              ...
              <View style={{ marginTop: 15, flexDirection: "row", gap: 10 }}>
                ...
                <Text style={{ color: "#f20000", flex: 1 }}>
                  Trong thời gian quy định nếu quý khách hủy phiếu khám sẽ được
                  hoàn tiền khám và các dịch vụ đặt thêm (không bao gồm phí tiện
                  ích)
                </Text>
              </View>
            </>
